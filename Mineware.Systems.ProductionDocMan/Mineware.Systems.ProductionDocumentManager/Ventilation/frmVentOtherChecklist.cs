...
namespace Mineware.Systems.DocumentManager.Ventilation
{
    public partial class frmVentOtherChecklist : DevExpress.XtraEditors.XtraForm
    {
        ...
        string ActionsImgDir = ProductionGlobal.ProductionGlobalTSysSettings._RepDir + @"\VentilationInspections\OtherInspections\ActionsImages";

        //string repDir = @"\\10.148.225.119\Mineware\Images\VentilationInspections\OtherInspections\DocumentFiles";    //Path to store files
        //string repImgDir = @"\\10.148.225.119\Mineware\Images\VentilationInspections\OtherInspections\Images";  //Path to store Images
        //string ActionsImgDir = @"\\10.148.225.119\Mineware\Images\VentilationInspections\OtherInspections\ActionImages";
        ...
        void GetFile()
        {
            ...
            if (result1 == DialogResult.OK)
            {
                ...
                {
                    FileName = procs.ExtractAfterColon(cbxChecklistId.EditValue.ToString());
                }
                else
                {
        ...
        private void DocsLB_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                string test = mianDicrectory + "\\" + procs.ExtractAfterColon(cbxChecklistId.EditValue.ToString()) + cbxWorkplace.EditValue.ToString() + String.Format("{0:yyyy-MM-dd}", txtProdMonth.EditValue) + DocsLB.SelectedItem.ToString();

                System.Diagnostics.Process.Start(mianDicrectory + "\\" + procs.ExtractAfterColon(cbxChecklistId.EditValue.ToString()) + cbxWorkplace.EditValue.ToString() + String.Format("{0:yyyy-MM-dd}", txtProdMonth.EditValue) + DocsLB.SelectedItem.ToString());
            }
        }
        ...
        private void btnDocRemove_Click(object sender, EventArgs e)
        {
            ...
            if (DocsLB.SelectedIndex != -1)
            {
                string test = mianDicrectory + "\\" + procs.ExtractAfterColon(cbxChecklistId.EditValue.ToString()) + cbxWorkplace.EditValue.ToString() + txtProdMonth.EditValue.ToString() + DocsLB.SelectedItem.ToString();

                System.Diagnostics.Process.Start(mianDicrectory + "\\" + procs.ExtractAfterColon(cbxChecklistId.EditValue.ToString()) + cbxWorkplace.EditValue.ToString() + txtProdMonth.EditValue.ToString() + DocsLB.SelectedItem.ToString());
            }
        }
        ...
        private void btnImgRemove_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in files)
            {
                ...
                string Test = repImgDir + "\\" + procs.ExtractAfterColon(cbxChecklistId.EditValue.ToString()) + cbxWorkplace.EditValue.ToString() + day + ext;
        ...
        {
            frmVentilationActionCapture ActFrm = new frmVentilationActionCapture();
            ActFrm.txtProdMonth.EditValue = procs.ProdMonthAsString(Convert.ToDateTime(txtProdMonth.EditValue.ToString()));
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in files)
            {
                ...
                string Test = repDir + "\\" + procs.ExtractAfterColon(cbxChecklistId.EditValue.ToString()) + cbxWorkplace.EditValue.ToString();

                Test = Test + String.Format("{0:yyyy-MM-dd}", txtProdMonth.EditValue);

                Test = Test + ext;

                if (item.ToString() == repDir + "\\" + procs.ExtractAfterColon(cbxChecklistId.EditValue.ToString()) + cbxWorkplace.EditValue.ToString() + String.Format("{0:yyyy-MM-dd}", txtProdMonth.EditValue).ToString() + ext)
                {
