...
{
    public partial class ucLineActionManager_Report : DevExpress.XtraEditors.XtraUserControl
    {

      
        private string ReportFolder =  @"\\10.148.225.119\Mineware\Syncromine\DocumentManager\";
        ...
        public ucLineActionManager_Report()
        {
            InitializeComponent();
        }
        ...
        void LoadActions()
        {
            ...
            _dbManFileID.ConnectionString = ConfigurationSettings.AppSettings["SQLConnectionStr"];
            _dbManFileID.SqlStatement = " exec sp_LineAction_Manager_LoadOpenActionsUser '" + Environment.UserDomainName + "'  ";
            ...
            dt = _dbManFileID.ResultsDataTable;
        ...
        void Load5Incidents()
        {
            ...
            try
            {
                ...
                var client = new DocumentManager.Models.ClientConnect();
                ...
                _Forms = JsonConvert.DeserializeObject<DocumentManager.Models.FormsAPI>(response);
        ...
        void Load5to10Incidents()
        {
           ...
           "values('" + dtNew.Rows[4]["IncidentNumber"] + "', '" + theCurrentPrintedFromID + "', '" + System.DateTime.Today + "', '5') \r\n";
            ...
            _dbManFileID2.ConnectionString = ConfigurationSettings.AppSettings["SQLConnectionStr"];
            ...
            _dbManInsert2.ConnectionString = ConfigurationSettings.AppSettings["SQLConnectionStr"];
        ...
        void Load10to15Incidents()
        {
           ...
           "values('" + dtNew.Rows[4]["IncidentNumber"] + "', '" + theCurrentPrintedFromID2 + "', '" + System.DateTime.Today + "', '5') \r\n";
            ...
            _dbManFileID3.ConnectionString = ConfigurationSettings.AppSettings["SQLConnectionStr"];
            ...
            _dbManInsert3.ConnectionString = ConfigurationSettings.AppSettings["SQLConnectionStr"];
        ...
        void Load15to20Incidents()
        {
           ...
           "values('" + dtNew.Rows[4]["IncidentNumber"] + "', '" + theCurrentPrintedFromID3 + "', '" + System.DateTime.Today + "', '5') \r\n";
            ...
            _dbManFileID4.ConnectionString = ConfigurationSettings.AppSettings["SQLConnectionStr"];
            ...
            _dbManInsert4.ConnectionString = ConfigurationSettings.AppSettings["SQLConnectionStr"];
        ...
        private void btnPrintChecklist_Click_1(object sender, EventArgs e)
        {
