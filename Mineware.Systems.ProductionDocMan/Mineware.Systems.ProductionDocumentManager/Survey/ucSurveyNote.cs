...
{
    public partial class ucSurveyNote : UserControl
    {
        ...
        {
            _userCurrentInfoConnection = ConfigurationSettings.AppSettings["SQLConnectionStr"];
            LoadNotes();
        }
        ...
        public void LoadNotes()
        {
            ...
            _dbManInsert.SqlStatement = "insert into [Mineware_Reporting].[dbo].[tbl_SurveyNote_Autorisation] " +


                                    "select [TSNID], 'Not Authorised', null, null, null, null, null, null, null, null, null, null " +
                                    ", null, null, null, null, null, null, null, null, null, null " +
                                    ", null, null, null, null, null, null, null, null, null, null, null,null,null,null,null,null " +
                                    "   from [Mineware_Reporting].[dbo].tbl_SurveyNote where [TSNID] not in  " +
                                    "(select [TSNID] from [Mineware_Reporting].[dbo].[tbl_SurveyNote_Autorisation])  ";
            ...
            _dbMan.SqlStatement = "Select convert(varchar(10),a.tsnid) Note, a.*, b.Description, CONVERT(VARCHAR(11),thedate,106) UseDate, 'No' aa, \r\n" +
                                    ...
                                    "a.IsCompleted = 'N' and " +
                                    "a.WorkplaceID = convert(varchar(10),b.WorkplaceID) and a.IsDeleted = 'N' " +
                                    "Order By a.TSNID ";
...
" end as Status,CONVERT(VARCHAR(11),lvl1date,106) lvl1date, case when lvl1date is null then null  else  datediff(dd,thedate,lvl1date) end as  aa, lvl1remks  from [Mineware_Reporting].[dbo].[tbl_SurveyNote_Autorisation] a left outer join [Mineware_Reporting].[dbo].[tbl_SurveyNote] c on a.tsnid = c.tsnid left outer join [dbo].tbl_Users_Department_Survey me on a.lvl1user = me.complogin left outer join tbl_Users b on b.userid = me.userid \r\n " +
" union \r\n " +
...
" from [Mineware_Reporting].[dbo].[tbl_SurveyNote_Autorisation] a left outer join [Mineware_Reporting].[dbo].[tbl_SurveyNote] c on a.tsnid = c.tsnid left outer join [dbo].tbl_Users_Department_Survey me on a.lvl2user = me.complogin left outer join tbl_Users b on b.userid = me.userid \r\n " +
" union \r\n " +
...
" from [Mineware_Reporting].[dbo].[tbl_SurveyNote_Autorisation] a left outer join [Mineware_Reporting].[dbo].[tbl_SurveyNote] c on a.tsnid = c.tsnid left outer join [dbo].tbl_Users_Department_Survey me on a.lvl3user = me.complogin left outer join tbl_Users b on b.userid = me.userid \r\n " +
" union \r\n " +
...
"from [Mineware_Reporting].[dbo].[tbl_SurveyNote_Autorisation] a left outer join [Mineware_Reporting].[dbo].[tbl_SurveyNote] c on a.tsnid = c.tsnid  left outer join [dbo].tbl_Users_Department_Survey me on a.lvl4user = me.complogin left outer join tbl_Users b on b.userid = me.userid \r\n " +
" union \r\n " +
...
" from [Mineware_Reporting].[dbo].[tbl_SurveyNote_Autorisation] a left outer join [Mineware_Reporting].[dbo].[tbl_SurveyNote] c on a.tsnid = c.tsnid  left outer join [dbo].tbl_Users_Department_Survey me on a.lvl5user = me.complogin left outer join tbl_Users b on b.userid = me.userid \r\n " +
" union \r\n " +
...
" from [Mineware_Reporting].[dbo].[tbl_SurveyNote_Autorisation] a left outer join [Mineware_Reporting].[dbo].[tbl_SurveyNote] c on a.tsnid = c.tsnid  left outer join [dbo].tbl_Users_Department_Survey me on a.lvl6user = me.complogin left outer join tbl_Users b on b.userid = me.userid \r\n " +
" union \r\n " +
...
" from [Mineware_Reporting].[dbo].[tbl_SurveyNote_Autorisation] a left outer join [Mineware_Reporting].[dbo].[tbl_SurveyNote] c on a.tsnid = c.tsnid  left outer join [dbo].tbl_Users_Department_Survey me on a.lvl7user = me.complogin left outer join tbl_Users b on b.userid = me.userid \r\n " +
" union \r\n " +
...
" from [Mineware_Reporting].[dbo].[tbl_SurveyNote_Autorisation] a left outer join [Mineware_Reporting].[dbo].[tbl_SurveyNote] c on a.tsnid = c.tsnid  left outer join [dbo].tbl_Users_Department_Survey me on a.lvl8user = me.complogin left outer join tbl_Users b on b.userid = me.userid ) a order by note, Processcode \r\n ";
