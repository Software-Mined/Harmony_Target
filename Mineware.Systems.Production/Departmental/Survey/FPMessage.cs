...
namespace Mineware.Systems.Production.Departmental.Survey
{
    public partial class FPMessage : XtraForm
    {
        ...
        private void FPMessage_Load(object sender, EventArgs e)
        {
            ...
            //    _dbManFP.ConnectionString = TConnections.GetConnectionString(_theSystemDBTag, _UserCurrentInfo);
        ...
        private void Loaddev()
        {
            ...
            _dbManEmptyCubby1.SqlStatement = "Select '" + ProductionGlobal.ProductionGlobalTSysSettings._RepDir + @"\SurveyLetters\" + ImageDateLbl + ".png" + "' ";
        ...
        private void LoadStartNote()
        {
            ...
            theReport.Load(TGlobalItems.ReportsFolder + "\\StartNote.frx");
...
" (Select* from vw_SurverLetters_Signature )b on a.ID = b.tsnid and a.UserName = b.username ";
            ...
            theReport.Load(TGlobalItems.ReportsFolder + "\\OpencastSurveyNote.frx");
...
" (Select* from vw_SurverLetters_Signature )b on a.ID = b.tsnid and a.UserName = b.username ";
            ...
            theReport.Load(TGlobalItems.ReportsFolder + "\\StopingNote.frx");
...
" (Select* from vw_SurverLetters_Signature )b on a.ID = b.tsnid and a.UserName = b.username ";
        ...
        private void LoadUserLvl()
        {
            ...
            _dbManCHKBy.ConnectionString = TConnections.GetConnectionString(_theSystemDBTag, _UserCurrentInfo);
            ...
            _dbManCHKBy.SqlStatement = "select " +
                                        ...
                                        " end as wwho from  [tbl_SurveyNote_Autorisation] " +
        ...
        private void LoadSurveyNote()
        {
            ...
            _dbManEmptyCubby.SqlStatement = "  select top(1) * from ( select a.*,  " +
                                       ...
                                       "  '' AdvToDate, '' HolDistPeg,  '' HoldingDistPegVal, '' Grade, '' PanelType,'" + ProductionGlobal.ProductionGlobalTSysSettings._Banner + "' banner,  \r\n " +
                                       ...
                                       " from  tbl_SurveyNote t, tbl_Workplace w , tbl_Section s, tbl_Section s1, tbl_Section s2   \r\n " +
            ...
            if (true)
            {
                theReport.Load(_reportFolder + "\\surveyNoteDevA3.frx");
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (FPTypeLbl.Text == "Survey Note")
            {
                ...
                _dbManaa.ConnectionString = TConnections.GetConnectionString(_theSystemDBTag, _UserCurrentInfo);
                if (Lvllbl.Text == "Checked By")
                    _dbManaa.SqlStatement = "select * from [tbl_Users_Synchromine] where UserID = '" + UserLbl.Text + "' ";
                if (Lvllbl.Text == "Snr Mine Surveyor")
                    _dbManaa.SqlStatement = "select Survey_SnrMineSurveyor from [tbl_Users_Synchromine] where UserID = '" + UserLbl.Text + "' and  Survey_SnrMineSurveyor = '1' ";
                if (Lvllbl.Text == "Geologist")
                    _dbManaa.SqlStatement = "select Survey_Geologist from [tbl_Users_Synchromine] where UserID = '" + UserLbl.Text + "' and  Survey_Geologist = '1' ";
                if (Lvllbl.Text == "Rock Mechanic")
                    _dbManaa.SqlStatement = "select Survey_RockMech from [tbl_Users_Synchromine] where UserID = '" + UserLbl.Text + "' and  Survey_RockMech = '1' ";
                if (Lvllbl.Text == "Snr Mine Planner")
                    _dbManaa.SqlStatement = "select Survey_SnrMinePlanner from [tbl_Users_Synchromine] where UserID = '" + UserLbl.Text + "' and  Survey_SnrMinePlanner = '1' ";
                if (Lvllbl.Text == "Sec Manager")
                    _dbManaa.SqlStatement = "select Survey_SecMan from [tbl_Users_Synchromine] where UserID = '" + UserLbl.Text + "' and  Survey_SecMan = '1' ";
                if (Lvllbl.Text == "Surv. Plan Manager")
                    _dbManaa.SqlStatement = "select Survey_SurvPlanMan from [tbl_Users_Synchromine] where UserID = '" + UserLbl.Text + "' and  Survey_SurvPlanMan = '1'";
                if (Lvllbl.Text == "Prod Manager")
                    _dbManaa.SqlStatement = "select Survey_ProdMan from [tbl_Users_Synchromine] where UserID = '" + UserLbl.Text + "' and  Survey_ProdMan = '1' ";
                if (Lvllbl.Text == "Mine Overseer")
                    _dbManaa.SqlStatement = "select Survey_MO from [tbl_Users_Synchromine] where UserID = '" + UserLbl.Text + "' and  Survey_SnrMineSurveyor = '1' ";
        ...
        private void AuthSurveyNote()
        {
            ...
            if (Lvllbl.Text == "Checked By")
                _dbMan.SqlStatement = " update  [tbl_SurveyNote_Autorisation] set Lvl1date = getdate(), lvl1remks = '" + RemBox.Text + "', lvl1OK = 'Yes',  lvl1User = '" + UserLbl.Text + "' where tsnid =  '" + FPNoLbl.Text + "' ";
            if (Lvllbl.Text == "Snr Mine Surveyor")
                _dbMan.SqlStatement = " update  [tbl_SurveyNote_Autorisation] set Lvl2date = getdate(), lvl2remks = '" + RemBox.Text + "', lvl2OK = 'Yes',  lvl2User = '" + UserLbl.Text + "' where tsnid =  '" + FPNoLbl.Text + "' ";
            if (Lvllbl.Text == "Geologist")
                _dbMan.SqlStatement = " update  [tbl_SurveyNote_Autorisation] set Lvl3date = getdate(), lvl3remks = '" + RemBox.Text + "', lvl3OK = 'Yes',  lvl3User = '" + UserLbl.Text + "' where tsnid =  '" + FPNoLbl.Text + "' ";
            if (Lvllbl.Text == "Rock Mechanic")
                _dbMan.SqlStatement = " update  [tbl_SurveyNote_Autorisation] set Lvl4date = getdate(), lvl4remks = '" + RemBox.Text + "', lvl4OK = 'Yes',  lvl4User = '" + UserLbl.Text + "' where tsnid =  '" + FPNoLbl.Text + "' ";
            if (Lvllbl.Text == "Snr Mine Planner")
                _dbMan.SqlStatement = " update  [tbl_SurveyNote_Autorisation] set Lvl5date = getdate(), lvl5remks = '" + RemBox.Text + "', lvl5OK = 'Yes',  lvl5User = '" + UserLbl.Text + "' where tsnid =  '" + FPNoLbl.Text + "' ";
            if (Lvllbl.Text == "Sec Manager")
                _dbMan.SqlStatement = " update  [tbl_SurveyNote_Autorisation] set Lvl6date = getdate(), lvl6remks = '" + RemBox.Text + "', lvl6OK = 'Yes',  lvl6User = '" + UserLbl.Text + "' where tsnid =  '" + FPNoLbl.Text + "' ";
            if (Lvllbl.Text == "Surv. Plan Manager")
                _dbMan.SqlStatement = " update  [tbl_SurveyNote_Autorisation] set Lvl7date = getdate(), lvl7remks = '" + RemBox.Text + "', lvl7OK = 'Yes',  lvl7User = '" + UserLbl.Text + "' where tsnid =  '" + FPNoLbl.Text + "' ";
            if (Lvllbl.Text == "Prod Manager")
                _dbMan.SqlStatement = " update  [tbl_SurveyNote_Autorisation] set Lvl8date = getdate(), lvl8remks = '" + RemBox.Text + "', lvl8OK = 'Yes',  lvl8User = '" + UserLbl.Text + "' where tsnid =  '" + FPNoLbl.Text + "' ";
            if (Lvllbl.Text == "Mine Overseer")
                _dbMan.SqlStatement = " update  [tbl_SurveyNote_Autorisation] set Lvl9date = getdate(), lvl9remks = '" + RemBox.Text + "', lvl9OK = 'Yes',  lvl9User = '" + UserLbl.Text + "' where tsnid =  '" + FPNoLbl.Text + "' ";
        ...
        private void DeclineBtn1_Click(object sender, EventArgs e)
        {
            ...
            if (Lvllbl.Text == "Checked By")
                _dbMan.SqlStatement = " update  [tbl_SurveyNote_Autorisation] set status = 'Declined', Lvl1date = getdate(), lvl1remks = '" + RemBox.Text + "', lvl1OK = 'Dec',  lvl1User = '" + UserLbl.Text + "' where tsnid =  '" + FPNoLbl.Text + "' ";
            if (Lvllbl.Text == "Snr Mine Surveyor")
                _dbMan.SqlStatement = " update  [tbl_SurveyNote_Autorisation] set status = 'Declined', Lvl2date = getdate(), lvl2remks = '" + RemBox.Text + "', lvl2OK = 'Dec',  lvl2User = '" + UserLbl.Text + "' where tsnid =  '" + FPNoLbl.Text + "' ";
            if (Lvllbl.Text == "Geologist")
                _dbMan.SqlStatement = " update  [tbl_SurveyNote_Autorisation] set status = 'Declined', Lvl3date = getdate(), lvl3remks = '" + RemBox.Text + "', lvl3OK = 'Dec',  lvl3User = '" + UserLbl.Text + "' where tsnid =  '" + FPNoLbl.Text + "' ";
            if (Lvllbl.Text == "Rock Mechanic")
                _dbMan.SqlStatement = " update  [tbl_SurveyNote_Autorisation] set status = 'Declined', Lvl4date = getdate(), lvl4remks = '" + RemBox.Text + "', lvl4OK = 'Dec',  lvl4User = '" + UserLbl.Text + "' where tsnid =  '" + FPNoLbl.Text + "' ";
            if (Lvllbl.Text == "Snr Mine Planner")
                _dbMan.SqlStatement = " update  [tbl_SurveyNote_Autorisation] set status = 'Declined',  Lvl5date = getdate(), lvl5remks = '" + RemBox.Text + "', lvl5OK = 'Dec',  lvl5User = '" + UserLbl.Text + "' where tsnid =  '" + FPNoLbl.Text + "' ";
            if (Lvllbl.Text == "Sec Manager")
                _dbMan.SqlStatement = " update  [tbl_SurveyNote_Autorisation] set status = 'Declined', Lvl6date = getdate(), lvl6remks = '" + RemBox.Text + "', lvl6OK = 'Dec',  lvl6User = '" + UserLbl.Text + "' where tsnid =  '" + FPNoLbl.Text + "' ";
            if (Lvllbl.Text == "Surv. Plan Manager")
                _dbMan.SqlStatement = " update  [tbl_SurveyNote_Autorisation] set status = 'Declined', Lvl7date = getdate(), lvl7remks = '" + RemBox.Text + "', lvl7OK = 'Dec',  lvl7User = '" + UserLbl.Text + "' where tsnid =  '" + FPNoLbl.Text + "' ";
            if (Lvllbl.Text == "Prod Manager")
                _dbMan.SqlStatement = " update  [tbl_SurveyNote_Autorisation] set status = 'Declined', Lvl8date = getdate(), lvl8remks = '" + RemBox.Text + "', lvl8OK = 'Dec',  lvl8User = '" + UserLbl.Text + "' where tsnid =  '" + FPNoLbl.Text + "' ";
        ...
        //                                _dbManzz.ConnectionString = TConnections.GetConnectionString(_theSystemDBTag, _UserCurrentInfo);
