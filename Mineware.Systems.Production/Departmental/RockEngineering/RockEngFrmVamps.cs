...
{
    public partial class RockEngFrmVamps : DevExpress.XtraEditors.XtraForm
    {
        ...
        public Image Base64ToImage(string base64String)
        {
            ...
            _dbManImage.SqlStatement = "update [tbl_DPT_RockMechInspection_Vamping] set picture = '" + s + "' where workplace = '" + WPLbl.EditValue + "' and captweek = '" + WkLbl2.EditValue + "' and captyear = datepart(year,getdate()) ";
        ...
        private void RockEngFrm_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //Cat62.MouseWheel += new MouseEventHandler(comboBox1_MouseWheel);
                //Cat63.MouseWheel += new MouseEventHandler(comboBox1_MouseWheel);
        ...
        void LoadReportLTO()
        {
            ...
            _dbMan.SqlStatement = " select '" + ProductionGlobal.ProductionGlobalTSysSettings._Banner + "' banner, " +
                                " RiskRating Risk, '" + RRlabel.EditValue + "' rr,  * from [tbl_DPT_RockMechInspection_Vamping] " +
                                 "  where workplace = '" + WPLbl.EditValue + "'\r\n" +
        ...
        void LoadReport()
        {
            ...
            MWDataManager.clsDataAccess _dbMan = new MWDataManager.clsDataAccess();
            _dbMan.ConnectionString = TConnections.GetConnectionString(ProductionRes.systemDBTag, _UserCurrentInfo);
            _dbMan.SqlStatement = " select '" + ProductionGlobal.ProductionGlobalTSysSettings._Banner + "' banner, RiskRating Risk, '" + RRlabel.EditValue + "' rr,  * from  [tbl_DPT_RockMechInspection_Vamping] where workplace = '" + WPLbl.EditValue + "' and CaptYear = datepart(YYYY,'" + String.Format("{0:yyyy-MM-dd}", date1.Value) + "') and CaptWeek = '" + WkLbl2.EditValue + "'  ";
            ...
            if (_dbMan.ResultsDataTable.Rows.Count > 0)
            {
                ...
                Cat3.EditValue = _dbMan.ResultsDataTable.Rows[0]["Cat3Checked"].ToString();
                ...
                Cat5.EditValue = _dbMan.ResultsDataTable.Rows[0]["Cat5Checked"].ToString();

                Cat6.EditValue = _dbMan.ResultsDataTable.Rows[0]["Cat6Checked"].ToString();


                Cat7.EditValue = _dbMan.ResultsDataTable.Rows[0]["Cat7Checked"].ToString();
                ...
                _dbManImage.SqlStatement = "Select RiskRating Risk,'" + BlankImage + "' pp, Picture,document1,document2 from  [tbl_DPT_RockMechInspection_Vamping] where workplace = '" + WPLbl.EditValue + "' and  captyear = (select max(CaptYear) from  [tbl_DPT_RockMechInspection_Vamping] where workplace = '" + WPLbl.EditValue + "' ) ";
                ...
                theReport3.Load(ReportsFolder + "\\RockEngVamp.frx");
            ...
            {
                _dbMan.ConnectionString = TConnections.GetConnectionString(ProductionRes.systemDBTag, _UserCurrentInfo);
                _dbMan.SqlStatement = " select '" + ProductionGlobal.ProductionGlobalTSysSettings._Banner + "' banner, '" + RRlabel.EditValue + "' rr,  * from [tbl_DPT_RockMechInspection_Vamping] where workplace = '" + WPLbl.EditValue + "'  order by captyear desc, convert(decimal(18,0),actweek)   desc ";
                _dbMan.queryExecutionType = MWDataManager.ExecutionType.GeneralSQLStatement;
                _dbMan.queryReturnType = MWDataManager.ReturnType.DataTable;
                _dbMan.ResultsTableName = "DevSummary";
                _dbMan.ExecuteInstruction();
        ...
        private void SaveBtn_Click(object sender, EventArgs e)
        {
            ...
            MWDataManager.clsDataAccess _dbMan = new MWDataManager.clsDataAccess();
            _dbMan.ConnectionString = TConnections.GetConnectionString(ProductionRes.systemDBTag, _UserCurrentInfo);
            _dbMan.SqlStatement = "Delete From [tbl_DPT_RockMechInspection_Vamping] Where workplace = '" + WPLbl.EditValue + "' and CaptYear = datepart(YYYY,'" + String.Format("{0:yyyy-MM-dd}", date1.Value) + "') and CaptWeek = '" + WkLbl2.EditValue + "' \r\n \r\n";
            _dbMan.SqlStatement = _dbMan.SqlStatement + " insert into [tbl_DPT_RockMechInspection_Vamping] VALUES ( '" + WPLbl.EditValue + "' , datepart(YYYY,'" + String.Format("{0:yyyy-MM-dd}", date1.Value) + "') , datepart(ISOWK,'" + String.Format("{0:yyyy-MM-dd}", date1.Value) + "') , datepart(ISOWK,'" + String.Format("{0:yyyy-MM-dd}", date1.Value) + "')  , getdate() , '" + TUserInfo.UserID + "' , \r\n " +

                                  " '" + cmbSB.EditValue.ToString() + "' , '" + cmbMO.EditValue.ToString() + "' , '" + RRlabel.EditValue + "', \r\n" +

                                  " '" + Cat1Check + "' , '" + Cat1Note.Text + "' , \r\n" +
                                  " '" + cat2Checked + "' , '" + Cat2Note.Text + "' , \r\n" +
                                  " '" + Cat3.EditValue + "' , '" + Cat3Note.Text + "' , \r\n" +
                                  " '" + cat4Checked + "' , '" + Cat4Note.Text + "' , \r\n" +
                                  " '" + Cat5.EditValue + "' , '" + Cat5Note.Text + "' , \r\n" +
                                  " '" + Cat6.EditValue + "' , '" + Cat6Note.Text + "' , \r\n" +
                                  " '" + Cat7.EditValue + "' , '" + Cat7Note.Text + "' , \r\n" +
