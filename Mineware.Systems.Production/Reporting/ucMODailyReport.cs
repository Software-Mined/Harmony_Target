...
{
    public partial class ucMODailyReport : BaseUserControl
    {
        ...
        public void LoadData()
        {
            ...
            //lueReport.Text = "Stoping";

            switch (cbxType.EditValue.ToString())
            {
                case "Development":
                    reportFileName = "MODailyDevelopment.frx";
                    tableName = "MODaily_Development_Data";
                    sql = @"EXEC [dbo].[sp_Bookings_Development] '" + ProductionGlobal.ProductionGlobal.ProdMonthAsString(Convert.ToDateTime(cbxBookingProdMonth.EditValue.ToString())) + @"', '" + cbxBookingMO.EditValue.ToString() + @"', '" + _numDay + @"'";

                    break;
                case "Development Cycle":
                    reportFileName = "MODailyDevelopment.frx";
                    tableName = "MODaily_Development_Data";
                    sql = @"EXEC [dbo].[sp_Bookings_Development_Cycle] '" + ProductionGlobal.ProductionGlobal.ProdMonthAsString(Convert.ToDateTime(cbxBookingProdMonth.EditValue.ToString())) + @"', '" + cbxBookingMO.EditValue.ToString() + @"', '" + _numDay + @"'";
                    break;
                case "Night Shift Development":
                    reportFileName = "MODailyDevelopmentNS.frx";
                    tableName = "MODaily_DevNS_Data";
                    sql = @"EXEC [dbo].[sp_Bookings_DevelopmentNS] '" + ProductionGlobal.ProductionGlobal.ProdMonthAsString(Convert.ToDateTime(cbxBookingProdMonth.EditValue.ToString())) + @"', '" + cbxBookingMO.EditValue.ToString() + @"', '" + _numDay + @"'";
                    break;
                case "Stoping":
                    reportFileName = "MODailyStoping.frx";
                    tableName = string.Empty;
                    sql = @"EXEC [dbo].sp_Bookings_Stoping '" + ProductionGlobal.ProductionGlobal.ProdMonthAsString(Convert.ToDateTime(cbxBookingProdMonth.EditValue.ToString())) + @"', '" + cbxBookingMO.EditValue.ToString() + @"', '" + _numDay + @"'";
                    break;
                case "Stoping Cycle":
                    reportFileName = "MODailyStoping.frx";
                    tableName = "Table1";
                    sql = @"EXEC [dbo].sp_Bookings_Stoping_Cycle '" + ProductionGlobal.ProductionGlobal.ProdMonthAsString(Convert.ToDateTime(cbxBookingProdMonth.EditValue.ToString())) + @"', '" + cbxBookingMO.EditValue.ToString() + @"', '" + _numDay + @"'";
                    break;
                case "Night Shift Stoping":
                    reportFileName = "MODailyStpNS.frx";
                    tableName = "MODaily_StopingNS_Data";
                    sql = @"EXEC [dbo].[sp_Bookings_StopingNS] '" + ProductionGlobal.ProductionGlobal.ProdMonthAsString(Convert.ToDateTime(cbxBookingProdMonth.EditValue.ToString())) + @"', '" + cbxBookingMO.EditValue.ToString() + @"', '" + _numDay + @"'";
                    break;
                case "Vamping":
                    reportFileName = "MODailyVamp.frx";
                    tableName = "MODaily_Vamping_Data";
                    sql = @"EXEC [dbo].[sp_MODaily_Vamping_Adv] '" + ProductionGlobal.ProductionGlobal.ProdMonthAsString(Convert.ToDateTime(cbxBookingProdMonth.EditValue.ToString())) + @"', '" + cbxBookingMO.EditValue.ToString() + @"'";
                    break;
                //New
                case "Stoping Compliance":
                    reportFileName = "MODailyStopingComp.frx";
                    tableName = string.Empty;
                    sql = @"EXEC [dbo].sp_Bookings_Stoping_Cycle_Compliance '" + ProductionGlobal.ProductionGlobal.ProdMonthAsString(Convert.ToDateTime(cbxBookingProdMonth.EditValue.ToString())) + @"', '" + cbxBookingMO.EditValue.ToString() + @"', '" + _numDay + @"'";
                    break;
                case "Development Compliance":
                    reportFileName = "MODailyDevelopmentComp.frx";
                    tableName = "MODaily_Development_Data";
                    sql = @"EXEC [dbo].[sp_Bookings_Development_Cycle_Compliance] '" + ProductionGlobal.ProductionGlobal.ProdMonthAsString(Convert.ToDateTime(cbxBookingProdMonth.EditValue.ToString())) + @"', '" + cbxBookingMO.EditValue.ToString() + @"', '" + _numDay + @"'";
                    break;
            }
