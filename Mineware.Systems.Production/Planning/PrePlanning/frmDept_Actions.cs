...
{
    public partial class frmDept_Actions : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmDept_Actions_Load(object sender, EventArgs e)
        {
            ...
            SupTypeCmp.Properties.Items.Clear();
            SupTypeCmp.Properties.Items.Add("Wire Mesh & Lacing 1m Block Pattern");
            SupTypeCmp.Properties.Items.Add("Wire Mesh and Lacing 1.5m Diamond Pattern");
            SupTypeCmp.Properties.Items.Add("Trussers");
            SupTypeCmp.Properties.Items.Add("Long Anchors 3.6m");
            SupTypeCmp.Properties.Items.Add("Rock Pop Sets 1.5m");
            SupTypeCmp.Properties.Items.Add("Bullhorn Sets");
        }
        ...
        private void btnSaveAct_Click(object sender, EventArgs e)
        {
            ...
            if (ActID == string.Empty)
            {
                sqlQuery = " INSERT INTO tbl_Shec_Incidents \r\n" +
                    ...
                    ", '" + lblWPDesc.Text + "','" + lblItemResults.Text + "','" + txtRemarks.Text + "',null,null " +
